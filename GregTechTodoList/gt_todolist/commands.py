...
def register_commands(builder: SimpleCommandBuilder, manager: TodoManager):
    ...
    def set_prop(source: CommandSource, context: CommandContext):
        ...
        if real_prop == "tier":
            ...
            if validated_tier:
                ...
                source.reply(Utils.error_msg(server, 'todo.msg.invalid_tier', len(GT_TIERS) - 1, ', '.join(GT_TIERS)))
                return
            ...
            if validated_prio:
                ...
                source.reply(Utils.error_msg(server, 'todo.msg.invalid_priority', ', '.join(PRIORITIES)))
                return
    ...
    def set_default_tier(source: CommandSource, context: CommandContext):
        ...
        if validated_tier:
            ...
            tier_text = Utils.get_tier_text(validated_tier)
